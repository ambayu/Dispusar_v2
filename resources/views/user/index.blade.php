            ...
            <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                <div class="tp-blog__item">
                    <div class="tp-blog__thumb p-relative fix">
                        <a href="#"><img class="w-100" src="{{ asset('assets/img/breadcurmb/bg-renjap.png') }}"
                                alt=""></a>
                        <span>
                    ...
                    <div class="tp-blog__content-wrap">
                        ...
                        <h5 class="tp-blog__title-sm"><a href="#">RENJA DISPERPUSTAKAAN Kota Medan
                                2023</a><br>
                        </h5>
                        <p class="text-secondary ">Rencana Kerja Dinas Perpustakaan dan Kearsipan Kota Medan Tahun 2023
                        </p>
                        <div class="tp-blog__link">
                            <a href="{{ asset('assets/files/RENJA 2023.pdf') }}">Download File <i
